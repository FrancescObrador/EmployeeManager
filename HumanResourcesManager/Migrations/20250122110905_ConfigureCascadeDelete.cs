    ...
    public partial class ConfigureCascadeDelete : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_employee_project", x => new { x.employee_id, x.project_id });
                    table.ForeignKey(
                        name: "FK_employee_project_employee_employee_id",
                        column: x => x.employee_id,
                        principalTable: "employee",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_employee_project_project_project_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_employee_project_project_id",
